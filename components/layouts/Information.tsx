			...
			<Container>
				...
				>
					<div>
						...
						<div className='flex flex-col 2xl:flex-row gap-[43px] mt-[64px] w-[220px] sm:w-[300px] md:w-[378px]'>
					...
					<Image
						className='absolute bottom-0 right-[-280px] sm:right-[-180px] xl:right-[20px] 2xl:right-[210px]'
						src={'/mentor.png'}
						width={525}
						height={808}
						alt='mentor'
